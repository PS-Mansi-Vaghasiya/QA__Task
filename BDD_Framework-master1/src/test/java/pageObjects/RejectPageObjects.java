...
public class RejectPageObjects extends SeleniumMethods {

	private static final URL fileInput = null;

	public RejectPageObjects(WebDriver driver) {
		super(driver);
	...
	private By markedinterviewpassed = By.xpath("//*[@class='orangehrm-recruitment']/div[2]/button[3]");
	...
	public void enterInterviewer(String interviewerName) {
	  ...
	  Thread.sleep(3000); clickOn(datebutton); sendKeys(datebutton, "2024-29-02");
	  
	  }
	  
	  public void selectInterviewTime() throws InterruptedException {
	  Thread.sleep(3000); clickOn(timebutton); clickOn(selecttime); }
	  
	  public void clickonsavebutton() { clickOn(saveButton); }
	  
		
		  public void clickOnMarkInterviewPassed() { clickOn(markedinterviewpassed); }
		  
		  public void clickOnOfferJobButton() throws InterruptedException {
		  Thread.sleep(2000); clickOn(offerjobbutton); }
		  
		  public void rejectbutton() { clickOn(rejectbutton); }
       ...
       public void contactnumberinvalid() {
       	...
       	sendKeys(contactNumberField, "cjsdnwdkndass");
       	clickOn(saveButton);
       }
